 ...
 */
public class Frag_league_playoff_calres extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_league_playoff_calres, container, false);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        SwipeRefresh=(SwipeRefreshLayout)view.findViewById(R.id.PlayoffCalResRefresh);
        round_sp=(Spinner)view.findViewById(R.id.l_poff_round_sp);
        content=(WebView)view.findViewById(R.id.l_poff_calres_content);
...
//                        Toast.makeText(getActivity().getBaseContext(),String.valueOf(parent.getItemAtPosition(position)),Toast.LENGTH_SHORT).show();
    ...
    private void getCurrweek(){
        ...
        String url =APISite+"/web/v1/getlastweek/"+getLang()+"/"+league+"/poff";
...
//            @Override
//            public void run() {
                path=APISite+"/data/v1/leagues/"+league+"/calres/poff/"+getLang()+"/";
                file=getLang()+"_"+league+"_calres_poff_"+String.valueOf(week)+".html";
