...
public class ImageRequest extends Request<Bitmap> {
     ...
     */
    @Deprecated
    public ImageRequest(String url, Response.Listener<Bitmap> listener, Response.ErrorListener errorListener1, int maxWidth, int maxHeight,
                        Object o, Config decodeConfig, Response.ErrorListener errorListener) {
